...
import { ParentModal } from "../../beginner_level_tasks/modal_component/ParentModal";
...
const Contactus=()=>{
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if(email==="" && name===""&&message==="" || email==="" && name==="hackerrank"  || email==="hackkerrank@hacker.com" && name===""){
    ...
    <p>Go to<button onClick={()=>navigate('/')}>Home</button>page </p>
    </>
};
