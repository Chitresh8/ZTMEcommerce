...
export const TodoList = () => {
  ...
  const enterClickHandler = () => {
    ...
    if(updateIndex===null){
      ...
      const updatedData = [...mapData]; // Create a copy of the current mapData
      updatedData[updateIndex] = todo; // Update the task at the updateIndex
      setMapData(updatedData); // Update the state with the new data
      setUpdateIndex(null); // Clear editing state
    }
    setTodo("");
